...
public:
    ...
    virtual bool initialize(void* window_handle, int32 width, int32 height, bool windowed);
    virtual void finalize();
    virtual bool render(Node* scene_root);
    
    virtual void setViewport(int32 width, int32 height) {}
    ...
    void setSSAOKernelSize(int32 value);
    int32 getSSAOKernelSize();
